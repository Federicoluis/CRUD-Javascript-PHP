    ...
    let url = 'http://localhost/empleados/';
            ...
            .then((respuesta)=>{
                respuesta.map(
                    function(empleado,index,array){
                        ...
                        datos+='<td><div class="btn-group" role="group" aria-label=""><button type="button" class="btn btn-success" onclick="app.editar('+empleado.id+')">Editar</button><button type="button" class="btn btn-danger" onclick="app.borrar('+empleado.id+')">Borrar</button></button></div>'+'</td>';
                        datos+="</tr>";
                    }
                );
